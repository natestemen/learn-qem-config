...
CIRCUIT="rotated_rb_circuits"                                #{ghz, mirror_circuits, rb_circuits, rotated_rb_circuits, random_clifford_t, w_state, qpe}
...
zne_batch_test = {
    "noise_scaling_factors": [[1, 3, 5, 7], [1, 3, 5]],  # Noise scaling values
    "noise_scaling_method": ["global", "local_random"],
...
circ, verify_func, ideal_result= get_circuit(CIRCUIT)
...
brute_force_search(circ, exe, ideal_result, zne_batch_test, results_file="results")


# LIGHT BRUTE FORCE SEARCH
# max_iter=10 # optional
# light_brute_force_search(circ , exe, ideal_result)
#light_brute_force_search(circ , exe, ideal_result, zne_batch_test, results_file="results")
...
#adaptive_search(circ , exe, ideal_result, results_file="results")
